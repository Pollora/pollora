...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p>{!! apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below.', 'woocommerce' ) ) !!}</p>{{--  @codingStandardsIgnoreLine  --}}
	...
	<p class="woocommerce-form-row form-row">
		...
		<button type="submit" class="woocommerce-Button button" value="@php esc_attr_e( 'Save', 'woocommerce' ); @endphp">@php esc_html_e( 'Save', 'woocommerce' ); @endphp</button>
	</p>
