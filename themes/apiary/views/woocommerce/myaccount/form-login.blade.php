	...
	<div class="u-column1 col-1 lg:col-start-1 lg:col-span-6">
		...
		<form class="woocommerce-form woocommerce-form-login login space-y-6 mt-6" method="post">
			...
			<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide space-y-1">
				...
				<div class="mt-1">
					<input class="woocommerce-Input woocommerce-Input--text input-text border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-xs focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" type="password" name="password" id="password" autocomplete="current-password" />
				</div>
			</div>
			...
			<div class="form-row">
				<div class="flex items-center justify-between">
					<div class="flex items-center">
						<input class="woocommerce-form__input woocommerce-form__input-checkbox h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded-sm" name="rememberme" type="checkbox" id="rememberme" value="forever" />
			...
			<form method="post" class="woocommerce-form woocommerce-form-register register space-y-6 mt-6" @php do_action( 'woocommerce_register_form_tag' ); @endphp >
				...
				@if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) )
					<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						...
						<div class="mt-1">
							<input type="password" class="woocommerce-Input woocommerce-Input--text input-text shadow-xs focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" name="password" id="reg_password" autocomplete="new-password" />
						</div>
					</div>
				@endif
