...
class PatternServiceProvider extends ServiceProvider
{
    ...
    {
        Action::add('init', [$this, 'registerThemeBlockPatterns']);
        Action::add('init', [$this, 'registerThemeBlockPatternCategories']);
    }
            ...
            if (file_exists($dirpath)) {
                ...
                if ($files) {
                    foreach ($files as $file) {
                        ...
                        $pattern_data['content'] = view(str_replace([get_stylesheet_directory().DS.'views'.DS, '.blade.php'], '', $file))->render();
