			...
			<div class="form-row">
				<div class="flex items-center justify-between">
					<div class="flex items-center">
						<input class="woocommerce-form__input woocommerce-form__input-checkbox h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded-xs" name="rememberme" type="checkbox" id="rememberme" value="forever" />
