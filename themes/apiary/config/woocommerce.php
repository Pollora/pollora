...
return [
    ...
    'review' => [
        'form' => [
            ...
            'label' => [
                'class' => 'block text-sm font-bold text-title mb-1',
            ],
            'textarea' => [
                'class' => 'bg-white-gray mt-1 block w-full sm:text-sm border border-gray-300 rounded-md',
            ],
            'input' => [
                'class' => 'mt-1 bg-white-gray block w-full sm:text-sm border-gray-300 rounded-md',
            ],
            'submit' => [
                'wrapper' => [
